...
def encode_repo_path(repo_path):
    """Encode a repo path the way Claude Code names its projects dir.

    Every non-alphanumeric char (/, _, ., -) becomes '-'; case is preserved.
    e.g. /Users/x/projects/my-app -> -Users-x-projects-my-app
    """
