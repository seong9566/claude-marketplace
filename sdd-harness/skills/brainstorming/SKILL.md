...
> **Model:** this skill demands hard thinking — design exploration and
> trade-off analysis. If the session is on a cheap tier, move up before
> starting and back down when done.
...
6. **Write design doc** — save to `docs/specs/YYYY-MM-DD-<topic>-design.md` and commit. This path is a default: if the repo's CLAUDE.md (or the user) names a specs directory, that wins — check before writing.
